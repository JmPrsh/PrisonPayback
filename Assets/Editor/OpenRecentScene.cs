			...
			if (!string.IsNullOrEmpty(scenePath))
			{
				...
				if (isPlayRequest)
				{
					...
					if ((scenePath != EditorApplication.currentScene)
						&& string.IsNullOrEmpty(SceneRestoreOnPlayStop))
					{
						SceneRestoreOnPlayStop = EditorApplication.currentScene;
					}
				}
...
#if (UNITY_3_5 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_5 || UNITY_4_6 || UNITY_5_0 || UNITY_5_1 || UNITY_5_2)
