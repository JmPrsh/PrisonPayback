...
//		RoomsHighscore = PlayerPrefs.GetInt ("RoomsHighscore");
//		CriticalsHighscore = PlayerPrefs.GetInt ("CriticalsHighscore");
//		BuffsHighscore = PlayerPrefs.GetInt ("BuffsHighscore");
//		TimePlayedHighscore = PlayerPrefs.GetInt ("TimePlayedHighscore");
...
//		} else {
//			KillAmount.text = "00";
//			HighestComboAmount.text = "00";
//			RoomsClearedAmount.text = "00";
//			CriticalHitsAmount.text = "00";
//			BuffsUsedAmount.text = "00";
//			TimePlayedAmount.text = "0m" + " 0s";
//		}
