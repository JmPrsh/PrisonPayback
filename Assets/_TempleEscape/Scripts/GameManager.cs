...
//
//            if (Random.valueCurrent< trapFrequency && ScoreManager.Instance.Score / scoreToCreateNewTrap >= 5)//Create torus trap
//            {
...
//
//            if (Random.valueCurrent<= trapFrequency && groundCount > 1 && trapCount < 2 && groundCount < groundNumberOnPath) //Create trap
//            {
//                trapCount++;
...
//            {
//                isCreatedSawTrap = false;
//                if (Random.valueCurrent< 0.5f && Random.valueCurrent<= stairFrequency) //Create stair
//                {
...
//                    nextPos = thisObject.transform.position + generateDirection * groundSize.x;
//
//                    if (Random.valueCurrent<= hiddenGroundFrequency && trapCount < 2 && groundCount > 1 && groundCount < groundNumberOnPath)
//                    {
//                        trapCount++;
...
//                    else
//                    {                        
//                        if (Random.valueCurrent<= obstacleFrequency && trapCount < 2 && groundCount > 1 && groundCount < groundNumberOnPath)
//                        {
//                            trapCount++;
...
//    {
//        if (Random.valueCurrent<= coinFrequency)
//        {
//            float factor = (Random.valueCurrent<= 0.5f) ? (1) : (2.5f);
...
//            {
//                int valueCurrent= Random.Range(0, 3);
//                if (valueCurrent== 0)
//                    return GetObject(listSpeedDownTrap);
//                else if (valueCurrent== 1)
//                    return GetObject(listThornTrap);
//                else
...
//            {
//                int valueCurrent= Random.Range(0, 4);
//                if (valueCurrent== 0)
//                    return GetObject(listSpeedDownTrap);
//                else if (valueCurrent== 1)
//                    return GetObject(listThornTrap);
...
//            {
//                int valueCurrent= Random.Range(0, 5);
//                if (valueCurrent== 0)
//                    return GetObject(listSpeedDownTrap);
//                else if (valueCurrent== 1)
//                    return GetObject(listThornTrap);
