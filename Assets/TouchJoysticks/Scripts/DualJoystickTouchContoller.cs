...
public class DualJoystickTouchContoller : MonoBehaviour
{
    ...
    public bool leftJoystickAlwaysVisible = false; // valueCurrentfrom left joystick that determines if the left joystick should be always visible or not
    public bool rightJoystickAlwaysVisible = false; // valueCurrentfrom right joystick that determines if the right joystick should be always visible or not
