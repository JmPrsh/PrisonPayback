...
namespace ChartboostSDK {
	...
	public class Chartboost: MonoBehaviour {
		...
		/// A return valueCurrentof true here indicates that the corresponding
		...
		/// See the enum valueCurrentcomments for descriptions on the values and their behavior.  Only use this feature if your application has the status bar enabled.
		/// </summary>
