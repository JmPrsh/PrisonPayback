...
namespace ChartboostSDK {
	public class CBExternal {
		...
		public static void didPassAgeGate(bool pass) {
			Log("Unity : didPassAgeGate with valueCurrent= " + pass);
		}
		...
		public static void setShouldPauseClickForConfirmation(bool pause) {
			Log("Unity : setShouldPauseClickForConfirmation with valueCurrent= " + pause);
		}
		...
		public static void setShouldRequestInterstitialsInFirstSession(bool request) {
			Log("Unity : setShouldRequestInterstitialsInFirstSession with valueCurrent= " + request);
		}
		...
		public static void setAutoCacheAds(bool autoCacheAds) {
			Log("Unity : setAutoCacheAds with valueCurrent= " + autoCacheAds);
		}

		public static void setStatusBarBehavior(CBStatusBarBehavior statusBarBehavior) {
			Log("Unity : setStatusBarBehavior with valueCurrent= " + statusBarBehavior);
		}

		public static void setShouldPrefetchVideoContent(bool shouldPrefetch) {
			Log("Unity : setShouldPrefetchVideoContent with valueCurrent= " + shouldPrefetch);
		}
		...
		public static void didPassAgeGate(bool pass) {
			...
			Log("iOS : didPassAgeGate with valueCurrent= " + pass);
		}
		...
		public static void setShouldPauseClickForConfirmation(bool pause) {
			...
			Log("iOS : setShouldPauseClickForConfirmation with valueCurrent= " + pause);
		}
		...
		public static void setShouldRequestInterstitialsInFirstSession(bool request) {
			...
			Log("iOS : setShouldRequestInterstitialsInFirstSession with valueCurrent= " + request);
		}
